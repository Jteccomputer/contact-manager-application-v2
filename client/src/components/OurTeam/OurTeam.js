    ...
    <section className={style.wrapper}>
      ...
      <div className={style.team_grp}>
        <div className={style.team_member}>
          ...
          <div className={style.memeber_name}>Chinedu Chukwuka</div>
          <div className={style.memeber_role}>Frontend Engineer</div>
        </div>
        <div className={style.team_member}>
          <img src={memeberPhoto} alt="" />
          <div className={style.memeber_name}>Ofega Afure</div>
          <div className={style.memeber_role}>Product Design & Integration</div>
        </div>
        <div className={style.team_member}>
          <img src={memeberPhoto} alt="" />
